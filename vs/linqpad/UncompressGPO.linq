...
var path = @"C:\Users\zzakaria\Desktop\blobs\C-AirWatchCache3653~\registry_registry_machine.xml";
...
var settingName = (doc.SelectSingleNode("/userEnvironmentSettings/setting/@name") as XmlAttribute)?.InnerText ?? "blah";
var settingElement = doc.SelectSingleNode("/userEnvironmentSettings/setting") as XmlElement;
var uncompressedDoc = Compression.GetUncompressedDocument(settingElement, settingName);
settingElement.RemoveAttribute("p");
settingElement.InnerXml = uncompressedDoc.SelectSingleNode("/userEnvironmentSettings/setting").InnerXml;
